...
class ResponsiveLayout extends StatelessWidget {
  ...
  // 🔥 MÉTODOS PARA TAMANHOS ADAPTATIVOS
  ...
  static double getPadding(BuildContext context, {required double mobile, double? tablet, double? desktop}) {
    if (isDesktop(context)) {
  ...
  static double getCardSize(BuildContext context, {required double mobile, double? tablet, double? desktop}) {
    if (isDesktop(context)) {
