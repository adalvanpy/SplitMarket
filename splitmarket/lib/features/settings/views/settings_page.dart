...
class SettingsPage extends StatelessWidget {
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                // 👈 CARD DA CONTA - AGORA NAVEGA PARA PROFILE
                _buildSettingsCard(
                  context: context,
  ...
  Widget _buildSettingsCard({
    ...
    Widget? trailing,
    VoidCallback? onTap, // 👈 PARÂMETRO ADICIONADO
  }) {
    return GestureDetector(
      onTap: onTap, // 👈 PERMITE CLIQUE NO CARD
      child: Container(
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(icon, color: const Color(0xFF8E76F7)),
            ),
